...
public class ItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void setIcon(LottieAnimationView imageView, int iconId) {
        //imageView.setImageResource(iconId);
        imageView.setAnimation(iconId);
    }
    ...
    private void setSelectedItemStyle(CardView parent, TextView title, LottieAnimationView icon, boolean isOpen, String parentColor, String tintColor) {
        if (isOpen) {
